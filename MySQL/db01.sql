...
INSERT INTO `blog` (`id`, `alias`, `file_id`, `created_at`)
VALUES (1, 'tut-tipa-umnyy-zagolovok', 182, '2020-12-08 20:25:15'),
...
INSERT INTO `blog_description` (`id`, `blog_id`, `language_id`, `name`, `short_description`, `description`, `tag`,
                                `meta_title`, `meta_description`, `meta_keyword`, `created_at`)
VALUES (1, 1, 1, 'Тут типа умный заголовок', 'А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка',
        '<p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка&nbsp;</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка<br></p>',
        'sdf', 'sfsd', 'fsdf', 'sf', '2020-12-08 20:25:15'),
       (2, 1, 3, 'Тут типа умный заголовок на англ',
        'А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка и все на агл',
        '<p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка и все на агл</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка и все на агл</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка и все на агл</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка и все на агл</p><hr><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка и все на агл</p><p>А тут ой какой интересный и завлекающий текст, прям не текст, а конфетка и все на агл<br></p>',
        'sfsdf', 'sf', 'sfs', 'fsf', '2020-12-08 20:25:15'),
       (3, 2, 1, 'А этот заголовок очень веселый', 'Веселый текст, веселый заголовок, веселые дети и прочая красота ',
        ...
        '', '', '', '', '2020-12-09 15:15:40'),
       (4, 2, 3, 'А этот заголовок очень веселый на англ', 'А этот заголовок очень веселый на англ',
        '<p>А этот заголовок очень веселый на англ</p><p>А этот заголовок очень веселый на англ</p><p>А этот заголовок очень веселый на англ</p><p>А этот заголовок очень веселый на англ</p><p>А этот заголовок очень веселый на англ</p><p>А этот заголовок очень веселый на англ</p><p>А этот заголовок очень веселый на англ<br></p>',
        '', '', '', '', '2020-12-09 15:15:40'),
       (5, 3, 1, 'Продажный заголовок',
        'Вот ты думаешь это будет полезная статья? Как бы не так, после не ты побежишь покупать мои товары',
        ...
        '', '', '', '', '2020-12-09 15:16:36'),
       (6, 3, 3, 'Продажный заголовок на англ',
        'Вот ты думаешь это будет полезная статья? Как бы не так, после не ты побежишь покупать мои товары',
        '<p><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\">Вот ты думаешь это будет полезная статья? Как бы не так, после не ты побежишь покупать мои товары</span></p><p><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\">Вот ты думаешь это будет полезная статья? Как бы не так, после не ты побежишь покупать мои товары</span></p><p><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\">Вот ты думаешь это будет полезная статья? Как бы не так, после не ты побежишь покупать мои товары</span></p><p><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\">Вот ты думаешь это будет полезная статья? Как бы не так, после не ты побежишь покупать мои товары</span></p><p><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\">Вот ты думаешь это будет полезная статья? Как бы не так, после не ты побежишь покупать мои товары</span></p><p><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\"><br></span><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\"><br></span><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\"><br></span><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\"><br></span><span style=\"color: rgb(119, 119, 119); font-family: Roboto, sans-serif; font-size: 15px;\"><br></span><br></p>',
        '', '', '', '', '2020-12-09 15:16:36');
...
INSERT INTO `category` (`id`, `parent_id`, `file_id`, `status`, `alias`)
VALUES (1, NULL, 179, 1, 'ot-0-do-2-let'),
...
INSERT INTO `category_description` (`id`, `category_id`, `language_id`, `name`, `short_description`, `description`)
VALUES (1, 1, 1, 'от 0 до 2 лет', 'Подходят для детей от от 0 до 2 лет', 'Подходят для детей от от 0 до 2 лет'),
...
INSERT INTO `comment` (`id`, `user_name`, `user_email`, `status`, `created_at`)
VALUES (1, 'Rita', 'margomonogarova@gmail.com', 1, '2020-12-08 23:08:25');
...
INSERT INTO `comment_answer` (`id`, `comment_id`, `created_at`)
VALUES (1, 1, '2020-12-08 23:08:52');
...
INSERT INTO `comment_answer_description` (`id`, `comment_answer_id`, `language_id`, `description`)
VALUES (1, 1, 1, 'Текст ответа RU'),
...
INSERT INTO `comment_answer_file` (`id`, `file_id`, `comment_answer_id`)
VALUES (1, 185, 1),
       (2, 186, 1);
...
INSERT INTO `comment_description` (`id`, `comment_id`, `language_id`, `description`)
VALUES (1, 1, 1, 'Текст отзыва RU'),
...
INSERT INTO `comment_file` (`id`, `file_id`, `comment_id`)
VALUES (1, 184, 1);
...
INSERT INTO `country` (`id`, `name`, `alpha2`, `alpha3`, `status`, `file_id`, `currency_id`)
VALUES (1, 'Россия', 'RU', 'RUS', 1, 126, 1),
...
INSERT INTO `coupon` (`id`, `code`, `discount`, `quantity`, `used`, `start_date`, `end_date`)
VALUES (2, '234', 45, 356456, 0, '2020-12-12 00:00:00', '2021-01-09 00:00:00'),
...
INSERT INTO `currency` (`id`, `name`, `code`, `alias`)
VALUES (1, 'Рубли', 'RUB', 'руб.'),
       (2, 'Доллары', 'USD', 'USD'),
       (3, 'Евро', 'EUR', 'EUR');
...
VALUES (1, 'russia', '1605206087russia.png', 'image/jpeg'),
       ...
       (191, '60EA2F44-DC30-43D8-B85B-94814A91C4DE', '160806278460EA2F44-DC30-43D8-B85B-94814A91C4DE.jpeg',
        'image/jpeg'),
       (192, '276B48CA-5BF2-4C69-ACAC-C8F88C2918CB', '1608063575276B48CA-5BF2-4C69-ACAC-C8F88C2918CB.jpeg',
        'image/jpeg'),
       (193, '681BB888-812D-4AE7-9341-F215D2BC2898', '1608063575681BB888-812D-4AE7-9341-F215D2BC2898.jpeg',
        'image/jpeg'),
       (194, '2B0580D4-CD39-4CE3-BC87-3E275193E149', '16080636572B0580D4-CD39-4CE3-BC87-3E275193E149.jpeg',
        'image/jpeg'),
       (195, '24E56038-9AF3-4BF7-9B20-53D83940C4FC', '160806365724E56038-9AF3-4BF7-9B20-53D83940C4FC.jpeg',
        'image/jpeg'),
       (196, '681BB888-812D-4AE7-9341-F215D2BC2898', '1608063657681BB888-812D-4AE7-9341-F215D2BC2898.jpeg',
        'image/jpeg'),
       (197, '1599155021Васильковый металлик', '16080637691599155021Васильковый металлик.png', 'image/png'),
       (198, '0581670B-F249-4943-A125-71DFCAAFBCBA', '16080637890581670B-F249-4943-A125-71DFCAAFBCBA.jpeg',
        'image/jpeg'),
       (199, 'D07A114F-4CF8-47F6-A9ED-BA1030BABD8A', '1608063789D07A114F-4CF8-47F6-A9ED-BA1030BABD8A.jpeg',
        'image/jpeg'),
       (200, '1599155021Васильковый металлик', '16080640561599155021Васильковый металлик.png', 'image/png'),
       (201, '35E90CAC-EC4D-4D32-82F4-536F970189B9', '160806418635E90CAC-EC4D-4D32-82F4-536F970189B9.jpeg',
        'image/jpeg'),
       (202, '37F0C709-7F10-49FA-B0B3-D6152C3A751B', '160806418637F0C709-7F10-49FA-B0B3-D6152C3A751B.jpeg',
        'image/jpeg'),
       (203, 'FA260F22-1089-4F35-B74B-8A257C536701', '1608064466FA260F22-1089-4F35-B74B-8A257C536701.jpeg',
        'image/jpeg'),
       (204, '99FC9B3E-4E8B-4629-8753-08914E55C619', '160806446699FC9B3E-4E8B-4629-8753-08914E55C619.jpeg',
        'image/jpeg'),
       (205, 'C864B392-AD4C-415D-8BCC-906CB62C74C0', '1608064466C864B392-AD4C-415D-8BCC-906CB62C74C0.jpeg',
        'image/jpeg'),
       (206, '9F05FC9F-751C-47EE-B4A2-C07910744A92', '16080649959F05FC9F-751C-47EE-B4A2-C07910744A92.jpeg',
        'image/jpeg'),
       (207, 'A07ABE3A-F155-4D66-BDC4-65B341153499', '1608064995A07ABE3A-F155-4D66-BDC4-65B341153499.jpeg',
        'image/jpeg'),
       (208, '7FC6A9FB-50AC-48E5-821A-B79B65D3A971', '16083971077FC6A9FB-50AC-48E5-821A-B79B65D3A971.JPG',
        'image/jpeg');
...
INSERT INTO `language` (`id`, `name`, `alias`, `code`, `file_id`)
VALUES (1, 'RU', 'russian', 'ru,ru_RU.UTF-8,ru_RU,russian', 1),
...
INSERT INTO `new` (`id`, `file_id`, `created_at`)
VALUES (1, 183, '2020-12-08 23:07:23'),
...
INSERT INTO `new_description` (`id`, `new_id`, `language_id`, `name`, `description`)
VALUES (1, 1, 1, 'Название RU', 'Текст RU'),
...
INSERT INTO `orders` (`id`, `first_name`, `last_name`, `email`, `telephone`, `country`, `city`, `postcode`, `address`,
                      `payment_method_id`, `shipping_method_id`, `comment`, `total_price`, `currency`, `status_id`,
                      `created_at`)
VALUES (2, 'Маргарита', 'Моногаровата1', 'argo@gmail.com1', '(999)16981421', 'Англия', 'Казань1', '1410021', '12', '1',
        '1', 'Ничего интересного', '4000.00', 'руб', 1, '2020-11-27');
...
INSERT INTO `order_payment_method` (`id`, `name`)
VALUES (1, 'Наличными курьеру'),
       (2, 'По карте курьеру'),
       (3, 'Оплата на карту'),
...
INSERT INTO `order_shipping_method` (`id`, `name`)
VALUES (1, 'Доставка курьером по Казани'),
...
INSERT INTO `product` (`id`, `category_id`, `size_id`, `type_id`, `price`, `sale`, `file_id`, `status`, `popular`,
                       `alias`, `sort`, `created_at`)
VALUES (8, 1, 4, 1, '0.00', NULL, 117, 1, 0, 'dsf', 0, NULL),
...
INSERT INTO `product_description` (`id`, `product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`,
                                   `meta_description`, `meta_keyword`)
VALUES (44, 19, 1, '\"Голова лисы\"', '', '', '', '', ''),
       (45, 19, 3, 'fox head', '', '', '', '', ''),
...
INSERT INTO `product_file` (`id`, `file_id`, `product_id`)
VALUES (12, 193, 21),
       (13, 195, 22),
       (14, 196, 22),
       (15, 199, 24),
...
INSERT INTO `rate` (`id`, `currency_id`, `rate`, `date`)
VALUES (7, 2, '73.32', '2020-12-20 00:00:00'),
...
INSERT INTO `role` (`id`, `name`, `permission`)
VALUES (1, 'Главный администратор', 100),
       (2, 'Администратор', 50);
...
INSERT INTO `sale_description` (`id`, `sale_id`, `language_id`, `name`, `sale`, `description`)
VALUES (1, 1, 1, 'Новогодняя распродажа', 'Скидка 10%!', 'В честь нового года мы устраиваем зимнюю распродажу'),
...
INSERT INTO `size_description` (`id`, `size_id`, `language_id`, `name`)
VALUES (1, 3, 1, 'Маленький'),
       (2, 3, 3, 'Small'),
       (3, 4, 1, 'Средний'),
       (4, 4, 3, 'Middle'),
       (5, 5, 1, 'Большой'),
...
INSERT INTO `type_description` (`id`, `type_id`, `language_id`, `name`)
VALUES (1, 1, 1, 'Бизиборды'),
       (2, 1, 3, 'Бизиборды Eng'),
...
VALUES (1, 'Маргарита Моногарова', 'margomonogarova@gmail.com', '3518eaf64ced211c19c16e606c1aa049', 'e0393605',
