...
class UserController implements ControllerStrategy
{
    ...
    {
        $this->controllerContext = new ControllerContext(new UserModel(),
            new ModelContext(new UserModel()), $this->directory);
